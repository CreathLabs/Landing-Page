...
const Service: React.FC<Props> = ({ title, body, icon, rotate }) => {
  return (
    <article
      className="w-full cursor-pointer relative bg-secondaryTwo space-y-3 px-3 md:px-[20px] flex flex-col items-center rounded-[20px] pt-14 pb-5 "
      data-aos="fade-up"
    >
      <h1 className="font-Playfair text-xl text-center font-semibold leading-[50px] ">
        {title}
      </h1>
      <h1 className="text-center text-base md:text-lg  font-light !leading-10  ">
        {body}
      </h1>
