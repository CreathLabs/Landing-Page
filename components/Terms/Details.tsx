  ...
  return (
    <div className=" my-10 space-y-4 container  max-w-screen-lg px-6 pt-16 mx-auto">
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        app (the “App”), and any other software, tools, features, or
        functionalities provided on or in connection with our products and
        services; including without limitation using our block chain services,
        also to view, explore, and use our tools, at your own discretion, to
        connect directly with others to purchase or sell products and services
        or transfer NFTs on public block chains (collectively, the “Service”).
        “NFT” in these Terms means a non-fungible token or similar digital item
        implemented on a block chain (such as the Ethereum block chain), which
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        interact with each other on NFTs, products and services available on
        public block chains. We do not have custody or control over the NFTs or
        block chains you are interacting with and we do not execute or
        effectuate purchases, transfers, or sales of such NFTs, products or
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        using the Service and we make no claims about the identity, legitimacy,
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        also be subject to these Terms). Those additional terms and conditions,
        which are available with the relevant service, then become part of your
        agreement with us if you use those products or services. In the event of
        a conflict between these Terms and any additional applicable terms we
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        as by providing notice through the Service or updating the “Last
        Updated” date at the beginning of these Terms. By continuing to access
        or use the Service, you confirm your acceptance of the revised Terms and
        all of the terms incorporated therein by reference effective as of the
        date these Terms are updated. It is your sole responsibility to review
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        (“Account”) will be associated with your block chain address; however,
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        Wallets are not operated by, maintained by, or affiliated with Creath,
        and Creath does not have custody or control over the contents of your
        wallet and has no ability to retrieve or transfer its contents. Creath
        ...
        regarding how the Service will operate with any specific wallet. You are
        solely responsible for keeping your wallet secure and you should never
        ...
        associated wallet and we are not liable for any acts or omissions by you
        in connection with your Account or as a result of your Account or wallet
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        foregoing, by using this Service, you represent and warrant that: (a)
        you are not located in, ordinarily resident in, or organized under the
        laws of any jurisdiction that is subject to a comprehensive Government
        ...
        government; (c) you are not owned or controlled, directly or indirectly,
        by any person that is subject to Sanctions, or organized under the laws
        of, any Embargoed Jurisdiction; (d) none of your officers, managers,
        directors, shareholders or authorized representatives is subject to
        Sanctions, or organized under the laws of, any Embargoed Jurisdiction,
        or is owned or controlled, directly or indirectly, by any person that is
        subject to Sanctions or that is located in, or organized under the laws
        of, any Embargoed Jurisdiction. You further covenant that the foregoing
        shall be true during the entire period of this agreement. If you access
        or use the Service outside the Federal Republic of Nigeria, you are
        solely responsible for ensuring that your access and use of the Service
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        investigate a potential violation of these Terms. In such cases, Creath,
        in its sole discretion, may disable your Account and block your ability
        to access the Service until such additional information and documents
        are processed by Creath. If you do not provide complete and accurate
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        the Service or other actions that Creath, in its sole discretion, may
        elect to take. If your Account becomes inactive for six months or
        longer, as determined by Creath in its sole discretion, you understand
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        materials contained therein, including, without limitation, the Creath
        logo and all designs, text, graphics, pictures, data, software, sound
        files, other files, and the selection and arrangement thereof are the
        proprietary property of Creath or our affiliates, licensors, or users,
        as applicable, and you agree not to take any action(s) inconsistent with
        such ownership interests. We and our affiliates, licensors, and users,
        as applicable, reserve all rights in connection with the Service and its
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        “Creath” or any other name, trademark or product or service name of
        Creath or our affiliates or licensors without our prior written
        permission. In addition, the “look and feel” of the Service constitutes
        the service mark, trademark or trade dress of Creath and may not be
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        property rights holder. Reference to any products, services, processes
        or other information by name, trademark, manufacturer, supplier or
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        agree that Creath may use and disclose Feedback in any manner and for
        ...
        hereby assign to Creath any and all right, title, and interest
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        Terms. If any software, content, or other materials owned by, controlled
        by, or licensed to us are distributed or made available to you as part
        of your use of the Service, we hereby grant you a non-commercial,
        personal, non-assignable, non-sub licensable, non-transferrable, and
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        about this third-party content visible through our Service, including
        any content associated with NFTs displayed on the Service, and you bear
        responsibility for verifying the legitimacy, authenticity, and legality
        of products, services, or NFTs that you purchase from third-party
        sellers. We also cannot guarantee that any products, services or NFTs
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        you click to get more details about any of the products visible on
        Creath, you may notice a third party link to the creator’s website. Such
        website may include Purchase Terms governing its use that you will be
        required to comply with. Creath is not a party to any such Purchase
        Terms, which are solely between the buyer and the seller. The buyer and
        seller are entirely responsible for communicating, promulgating,
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        Application, though we may not warn you that you have left our Service,
        you are subject to the terms and conditions (including privacy policies)
        of another website or destination. Such Third-Party Websites,
        Third-Party Applications, and Third-Party Materials are not under the
        control of Creath, and may be “open” applications for which no recourse
        is possible. Creath is not responsible or liable for any Third-Party
        Websites, Third-Party Applications, and Third-Party Materials. Creath
        provides links to these Third-Party Websites and Third-Party
        Applications only as a convenience and does not review, approve,
        monitor, endorse, warrant, or make any representations with respect to
        Third-Party Websites or Third-Party Applications, or their products or
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        protect our community and comply with our legal obligations, we reserve
        the right to take action, with or without advance notice, if we believe
        you have violated these Terms. This may include: removing the ability to
        view certain NFTs on the Service or use our Service to interact with the
        NFTs; disabling the ability to use the Service in conjunction with
        buying/selling/transferring all products, services or NFTs available on
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        part, by any other person; Claim a Creath username for the purpose of
        reselling it, confusing others, deriving others’ goodwill, or otherwise
        engage in name squatting; Access the Service from a different block
        chain address if we’ve blocked any of your other block chain addresses
        from accessing the Service, unless you have our written permission
        first; Distribute spam, including through sending unwanted NFTs to other
        users; Use the Service – including through disseminating any software or
        interacting with any API – that could damage, disable, overburden, or
        impair the functioning of the Service in any manner; Bypass or ignore
        instructions that control access to the Service, including attempting to
        circumvent any rate limiting systems by using multiple API keys,
        directing traffic through multiple IP addresses, or otherwise
        obfuscating the source of traffic you send to Creath; Use our Service
        for commercial purposes inconsistent with these Terms or any other
        instructions; Use any data mining, robot, spider, crawler, scraper,
        script, browser extension, offline reader, or other automated means or
        interface not authorized by us to access the Service, extract data, or
        otherwise interfere with or modify the rendering of Service pages or
        functionality; Reverse engineer, duplicate, decompile, disassemble, or
        decode any aspect of the Service, or do anything that might discover
        source code or bypass or circumvent measures employed to prevent or
        limit access to any service, area, or code of the Service; Sell or
        resell the Service or attempt to circumvent any Creath fee systems;
        ...
        other metrics that Creath might use to sort search results; Use the
        Service or data collected from our Service for any advertising or direct
        marketing activity (including without limitation, email marketing, SMS
        marketing, and telemarketing); Use the Service for or in connection with
        money laundering, terrorist financing, or other illicit financial
        activity, or in any way in connection with the violation of any law or
        regulation that applies to you or to Creath; Use the Service, directly
        or indirectly, for, on behalf of, or for the benefit of, (a) any natural
        or legal person that is the subject of Sanctions; (b) any natural or
        legal person located in, ordinarily resident in, or organized under the
        laws of, any Embargoed Jurisdiction; or (c) any legal person owned or
        ...
        Embargoed Jurisdiction; Use the Service to carry out any financial
        ...
        commodities, options, or debt instruments; Use the Service to create,
        sell, or buy items that give owners’ rights to participate in an ICO or
        any securities offering, or that are redeemable for securities,
        commodities, or other financial instruments; Use the Service to engage
        in price manipulation, fraud, or other deceptive, misleading, or
        manipulative activity; Use the Service to buy, sell, or transfer stolen
        ...
        intellectual property rights or any other rights of others; Create or
        display illegal content, such as content that may involve child sexual
        exploitation; Create or display items that promote suicide or self-harm,
        incites hate or violence against others, or doxes another individual;
        Use the Service for any illegal or unauthorized purpose, including
        creating or displaying illegal content, such as content that may involve
        child sexual exploitation, or encouraging or promoting any activity that
        violates the Terms of Service; Use the Service in any manner that could
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        products, services, items, NFT, collections, or account that you view or
        otherwise interact with in conjunction with our Products or Services. We
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        post, promote, or display on or through the Service. You represent and
        warrant that such content does not contain material subject to
        copyright, trademark, publicity rights, or other intellectual property
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        claims and will terminate a user's access to the Service if the user is
        determined to be a repeat infringer. If you believe that your content
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        be removed, including a description of the specific location (i.e.,
        urls) on the Service of the material claimed to be infringing, so that
        we may locate the material; Your contact information – at a minimum,
        your full legal name (not pseudonym) and email address; A declaration
        that contains all of the following: A statement that you have a good
        faith belief that use of the material in the manner complained of is not
        authorized by the intellectual property rights owner, its agent, or the
        law; A statement that the information in the notice is accurate; and A
        statement under penalty of perjury that you are authorized to act on
        behalf of the intellectual property owner of the intellectual property
        that is allegedly being infringed. Your physical or electronic signature
        (of your full legal name). Please note that we will forward your notice
        of intellectual property infringement, including your contact
        information, to the party who will have their content removed so they
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        relationship with us. We may also send you promotional communications
        via email we think will be of interest to you. You understand that you
        are not required to provide this consent as a condition of using the
        Service and you may opt out of these communications through the Service
        or through your mobile device’s operating system (with the possible
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        apply, but solely with respect to your use of the App from the Apple App
        or Google Play Store. You acknowledge and agree that these Terms are
        solely between you and Creath, not Apple or Google, and that
        Apple/Google has no responsibility for the App or content thereof. Your
        use of the App must comply with the App Store’s applicable terms of use.
        You acknowledge that Apple/Google has no obligation whatsoever to
        furnish any maintenance and support services with respect to the App. In
        the event of any failure of the App to conform to any applicable
        warranty, you may notify Apple/Google, and Apple/Google will refund the
        purchase price, if any, for the App to you. To the maximum extent
        permitted by applicable law, Apple/Google will have no other warranty
        ...
        Terms. You acknowledge that Apple/Google is not responsible for
        ...
        intellectual property rights, Creath, not Apple/Google, will be solely
        ...
        beneficiaries of these Terms as they relate to your use of the App, and
        that, upon your acceptance of these Terms, Apple/Google will have the
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        successors, and assigns (individually and collectively, the “Creath
        Parties”), from and against all actual or alleged claims, damages,
        awards, judgments, losses, liabilities, obligations, taxes, penalties,
        ...
        related to (a) your use or misuse of the Service, product, content,
        NFTs, or content linked to or associated with any NFTs (b) any Feedback
        you provide, (c) your violation or breach of any term of these Terms or
        applicable law, and (d) your violation of the rights of or obligations
        to a third party, including another user or third-party, and (e) your
        negligence or willful misconduct. You agree to promptly notify Creath of
        any Claims and cooperate with the Creath Parties in defending such
        Claims. You further agree that the Creath Parties shall have control of
        the defense or settlement of any Claims. THIS INDEMNITY IS IN ADDITION
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        OF ANY KIND, EITHER EXPRESS OR IMPLIED. CREATH (AND ITS SUPPLIERS) MAKE
        NO WARRANTY OR REPRESENTATION AND DISCLAIM ALL RESPONSIBILITY FOR
        WHETHER THE SERVICE: (A) WILL MEET YOUR REQUIREMENTS; (B) WILL BE
        ...
        NON-INFRINGEMENT. CREATH WILL NOT BE LIABLE FOR ANY LOSS OF ANY KIND
        FROM ANY ACTION TAKEN OR TAKEN IN RELIANCE ON MATERIAL OR INFORMATION,
        CONTAINED ON THE SERVICE. WHILE CREATH ATTEMPTS TO MAKE YOUR ACCESS TO
        AND USE OF THE SERVICE SAFE, CREATH CANNOT AND DOES NOT REPRESENT OR
        WARRANT THAT THE SERVICE, CONTENT, CONTENT LINKED TO OR ASSOCIATED WITH
        ANY PRODUCTS, ITEMS, NFTS, OR ANY INTERACTION WITH USING OUR SERVICE OR
        OUR SERVICE PROVIDERS’ SERVERS ARE FREE OF VIRUSES OR OTHER HARMFUL
        COMPONENTS. WE CANNOT GUARANTEE THE SECURITY OF ANY DATA THAT YOU
        DISCLOSE ONLINE. NO ADVICE OR INFORMATION, WHETHER ORAL OR OBTAINED FROM
        THE CREATH PARTIES OR THROUGH THE SERVICE, WILL CREATE ANY WARRANTY OR
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        WITH NFTS, INCLUDING BUT NOT LIMITED TO ANY LOSSES, DAMAGES, OR CLAIMS
        ARISING FROM: (A) USER ERROR, INCORRECTLY CONSTRUCTED TRANSACTIONS, OR
        MISTYPED ADDRESSES; (B) SERVER FAILURE OR DATA LOSS; (C) UNAUTHORIZED
        ACCESS OR USE; (D) ANY UNAUTHORIZED THIRD-PARTY ACTIVITIES, INCLUDING
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        FEATURES AVAIALBE FOR USE. NO CREATH PARTY IS RESPONSIBLE FOR LOSSES OR
        INJURY DUE TO LATE REPORTS BY DEVELOPERS OR REPRESENTATIVES (OR NO
        REPORT AT ALL) OF ANY ISSUES WITH THE BLOCK CHAIN SUPPORTING THE NFTS,
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        not responsible for determining, withholding, collecting, reporting, or
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        and acknowledge that Creath will not be responsible for any
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        inability to view items on Creath or an inability to use the Service in
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        PRODUCTS OR THIRD-PARTY SITES AND PRODUCTS, OR FOR ANY DAMAGES RELATED
        TO LOSS OF REVENUE, LOSS OF PROFITS, LOSS OF BUSINESS OR ANTICIPATED
        ...
        CONTRACT, OR OTHERWISE, EVEN IF FORESEEABLE AND EVEN IF CREATH OR ITS
        SERVICE PROVIDERS HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES;
        OR (B) FOR ANY OTHER CLAIM, DEMAND, OR DAMAGES WHATSOEVER RESULTING FROM
        OR ARISING OUT OF OR IN CONNECTION WITH THESE TERMS OF THE DELIVERY,
        USE, OR PERFORMANCE OF THE SERVICE. ACCESS TO, AND USE OF, THE SERVICE,
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        CONTENT, ITEMS, NFTS, OR ANY CREATH PRODUCTS OR SERVICES EXCEED THE
        GREATER OF (A) $100 OR (B) THE AMOUNT RECEIVED BY CREATH FOR ITS SERVICE
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        or between users and third parties. Creath does not provide dispute
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        any aspect of your relationship with Creath, will be resolved by binding
        arbitration, rather than in court, including threshold questions of the
        arbitrability of such dispute, controversy, or claim except that (1) you
        or Creath may assert claims in small claims court, but only if the
        claims qualify, the claims remain only in such court, and the claims
        remain on an individual, non-representative, and non-class basis; and
        (2) you or Creath may seek injunctive or equitable relief in a court of
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        resolution process by sending a letter describing the nature of your
        claim and desired resolution to: Creath Innovations Ltd, Attn: Legal
        Department, 40A, Oyibo Adjarho Street, Lekki Phase 1, Lagos State,
        Nigeria. Both parties agree to meet and confer personally, by telephone,
        or by video conference (hereinafter “Conference”) to discuss the dispute
        and attempt in good faith to reach a mutually beneficial outcome that
        avoids the expenses of arbitration or, where applicable, litigation. If
        you are represented by counsel, your counsel may participate in the
        Conference as well, but you agree to fully participate in the
        Conference. Likewise, if Creath is represented by counsel, its counsel
        may participate in the Conference as well, but Creath agrees to have a
        company representative fully participate in the Conference. The statute
        of limitations and any filing fee deadlines shall be tolled while the
        parties engage in the informal dispute resolution process and Conference
        required by this paragraph. If the parties do not reach agreement to
        resolve the dispute within thirty (30) days after initiation of this
        dispute resolution process, either party may commence arbitration, file
        an action in small claims court, or file a claim for injunctive or
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        resolution process, you must send a letter requesting arbitration and
        describing your claim to our registered agent at Creath Innovations Ltd,
        Attn: Legal Department,40A, Oyibo Adjarho Street, Lekki Phase 1, Lagos
        State, Nigeria. The arbitration will be conducted in English. You are
        ...
        witnesses. You may choose to have the arbitration conducted by telephone
        or video conference, based on written submissions, in person in Lagos
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        of this Arbitration Agreement is void or voidable. The arbitration will
        decide the rights and liabilities, if any, of you and Creath. The
        ...
        applicable law, rules, and these Terms. The arbitrator shall issue a
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        (“Applicability of Arbitration Agreement”). An arbitrator can award on
        an individual basis the same damages and relief as a court and must
        follow these Terms as a court would. However, there is no judge in
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        LIMITATION) OR COLLECTIVE CLASS BASIS. ONLY INDIVIDUAL RELIEF IS
        AVAILABLE, AND CLAIMS OF MORE THAN ONE USER, PERSON, OR ENTITY CANNOT BE
        ARBITRATED OR CONSOLIDATED WITH THOSE OF ANY OTHER USER, PERSON, OR
        ENTITY. Accordingly, under the arbitration procedures outlined in this
        section, an arbitrator shall not combine or consolidate more than one
        party’s claims to an arbitration proceeding. Without limiting the
        generality of the foregoing, you and Creath agree that no dispute shall
        proceed by way of class arbitration. If a decision is issued stating
        that applicable law precludes enforcement of any part of this
        subsection’s limitations as to a given claim for relief, then that claim
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        (30) days of such change becoming effective by writing to Creath at the
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        license or approval. In particular, but without limitation, the Service
        may not be exported or re-exported (a) into any embargoed countries or
        any country that has been designated by the Government as a “terrorist
        supporting” country, or (b) to anyone listed on any Government list of
        prohibited or restricted parties. By using the Service, you represent
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        assigned by you without the prior written consent of Creath, and
        Creath’s failure to assert any right or provision under these Terms
        shall not constitute a waiver of such right or provision. No waiver by
      ...
      <p className="text-secondary text-base text-justify md:text-[17px]  leading-10">
        ...
        compliance with applicable laws. You and Creath agree that the
