...
const Menu: React.FC<{
  ...
  return (
    <div
      className="fixed xl:hidden top-0 overflow-hidden left-0 right-0 bottom-0  z-40 transition-all duration-700 ease-in-out menu_bg "
      style={{
    ...
    >
      ...
      <div
        className="absolute bottom-14 left-0 right-0 px-6 transition-all duration-700 ease-in-out "
        style={{
